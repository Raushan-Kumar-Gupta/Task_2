        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-white">Modern</h3>
            </div>
            <p className="mb-4 text-gray-400">
              Creating beautiful, responsive websites with modern technologies and design principles.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/contact" className="text-gray-400 hover:text-white transition-colors">Contact</NavLink>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">SEO Services</a>
              </li>
            </ul>
          </div>
